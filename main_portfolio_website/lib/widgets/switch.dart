        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: _circleAnimation.value == Alignment.centerRight ? Colors.grey[100] : Colors.black,
            ),
            child: Padding(
              ...
              child: Container(
                ...
                child: Container(
                  width: 20.0,
                  height: 20.0,
                  decoration: const BoxDecoration(shape: BoxShape.circle, color: darkPrimaryColor),
                  child: Icon(
